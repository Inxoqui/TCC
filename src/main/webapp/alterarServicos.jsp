...
<body>
	...
	<section id="container">
		...
		<form name="formServico" action="editarS" method="get">
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">ID</label> <input
					type="text" name="idServico" class="form-control"
					id="formGroupExampleInput"
					value="<%out.print(request.getAttribute("idServico"));%>">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<label for="formGroupExampleInput3" class="form-label">Valor</label>
