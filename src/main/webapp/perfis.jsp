			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-link disabled" aria-disabled="true">Perfis</a></li>
					</ul>
				</div>
			</div>
		</nav>
		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td></td>
					<td><a href="formPerfil"><i class="fa-solid fa-plus"></i></a>
					</td>
				</tr>
				<%
				...
				%>
				<tr>
					<td><%=lista.get(i).getIdPerfil()%></td>
					<td><%=lista.get(i).getPerfil()%></td>
					<td><a
						href="carregarPerfil?idPerfil=<%=lista.get(i).getIdPerfil()%>"><i
							class="fa-solid fa-pen"></i></a> <a
						href="javascript: confirmar(<%=lista.get(i).getIdPerfil()%>)"><i
	...
	<script type="text/javascript">
		function confirmar(idPerfil) {
			...
			if (resposta === true) {
				...
				window.location.href = "excluirPerfil?idPerfil=" + idPerfil
			}
		}
	</script>
</body>
